...
2. Komendy lokalne → file bridge: `write_to_file req-*.json` → 5s → `view_file res-*.json`
...
### Krok 1 — Znajdź WP post przez file bridge

```json
req-vse-architect-01-val-01.json:
{
  "id": "vse-architect-01-val-01",
